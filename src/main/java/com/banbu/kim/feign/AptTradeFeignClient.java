...
@FeignClient(name = "aptTradeClient", url = "http://apis.data.go.kr")
public interface AptTradeFeignClient {
         ...
         */
        @GetMapping(value = "/1613000/RTMSDataSvcAptTradeDev/getRTMSDataSvcAptTradeDev", produces = MediaType.APPLICATION_XML_VALUE)
